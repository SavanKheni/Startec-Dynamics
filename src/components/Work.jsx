...
const ICONS = [
  {
    ...
    subtitle: "Through Intelligent Innovation",
    description:
      "We develop advanced AI-powered solutions that enhance vehicle safety, connectivity, efficiency, and user experience across conventional and next-generation transportation platforms. Our focus lies in creating practical technologies that address real-world mobility challenges, particularly in emerging markets where accessible and affordable innovation can have the greatest impact. By integrating artificial intelligence, IoT connectivity, data analytics, and smart automation, we enable vehicles to become more intelligent, responsive, and connected.",
    paths: [
  ...
  },
  {
    ...
    subtitle: "for Smarter, Safer Mobility",
    description:
      "The company focuses on developing smart, connected solutions that enhance vehicle safety, operational efficiency, and real-time decision-making. By integrating intelligent monitoring systems, data analytics, connectivity, and automation, Startec Dynamics enables vehicles to become more responsive, secure, and efficient. Its technologies are designed to address the evolving needs of modern transportation, helping create safer roads, smarter mobility ecosystems, and more sustainable transportation solutions for individuals, businesses, and communities alike.",
    paths: [
      {
  ...
  },
  {
    ...
    description:
      "Leveraging advanced cloud server infrastructure, the company develops connected, scalable, and data-driven mobility solutions that enhance vehicle intelligence, safety, and operational efficiency. By integrating cloud computing with smart mobility technologies, Startec Dynamics enables real-time data processing, remote monitoring, predictive analytics, and seamless connectivity between vehicles, users, and service platforms. This cloud-powered approach allows for continuous software updates, improved system reliability, and the flexibility to support emerging mobility applications, helping create smarter, safer, and more sustainable transportation ecosystems for the future.",
    paths: [
      {
  ...
  },
  {
    ...
    viewBox: "0 0 32 32",
    title: "Powering Next-Generation",
    subtitle: "Mobility with the Smart System",
    description:
      "By integrating its advanced Smart System into vehicles, the company enables a new generation of connected, data-driven, and safer transportation solutions. The Smart System chip acts as the core intelligence platform, delivering real-time monitoring, vehicle connectivity, location tracking, rider assistance, crash detection, and predictive insights that enhance both safety and operational efficiency. Designed for practical deployment across conventional vehicles, electric vehicles, and fleet applications, Startec Dynamics’ technology bridges the gap between mobility and digital intelligence, creating smarter, more responsive, and more sustainable transportation ecosystems for the modern world.",
    strokePaths: [
...
const TABS = [
  {
    ...
    title: "SI Connect",
    description1:
      "SI Connect transforms everyday riding into a smarter, safer, and more connected experience. Powered by the SI Smart Tracker and an intelligent mobile application, the platform helps riders stay informed, protected, and in control at all times.",
    description2:
      "The SI Smart Tracker continuously monitors vehicle activity, location, ride movement, and critical alerts in real time. Connected through the SI Connect Mobile App, riders can instantly access live tracking, trip history, safety notifications, anti-theft protection, and emergency support features directly from their smartphone.",
  ...
  {
    id: 2,
    label: "SI Smart Device",
    colorClass: "tab--purple",
    title: "SI Intelligent",
    description1:
      "The SI Smart Device is an intelligent safety and connectivity system designed to transform conventional motorcycles and mobility vehicles into smarter, safer, and connected platforms. Built for real-world riding conditions, the device combines crash detection, emergency communication, live vehicle monitoring, and smart connectivity into a compact integrated solution.",
    description2:
      "In the event of an accident, the SI Smart Device can automatically detect a crash and instantly trigger emergency alerts with the rider’s live location. This helps reduce response delays and improves the chances of timely medical assistance, especially in regions where riders often travel alone or in remote areas.",
    buttonLabel: "Explore The Project",
    image: [sIIntelligent],
...
const floatConfigs = [
  { y: [-10, 0], rotate: [0.5, -0.5], duration: 5.8, delay: 1.4 },
  { y: [-8, 0], rotate: [0.3, -0.3], duration: 5.0, delay: 0.8 },
  { y: [-12, 0], rotate: [0.4, -0.4], duration: 6.5, delay: 1.1 },
];
...
// ─── Icon Detail Modal ────────────────────────────────────────────────────────
const IconDetailModal = ({ icon, onClose }) => {
  if (!icon) return null;

  return (
    // REMOVED internal <AnimatePresence> wrapper from here
    <motion.div
      className="icon-modal-overlay"
    ...
    >
      ...
      >
        ...
        <button className="icon-modal-close" onClick={onClose}>
          ...
          >
            <path
              d="M9.89949 24.0413C13.7886 27.9304 20.1525 27.9304 24.0416 24.0413C27.9307 20.1522 27.9307 13.7883 24.0416 9.89919C20.1525 6.01011 13.7886 6.01011 9.89949 9.89919C6.01041 13.7883 6.01041 20.1522 9.89949 24.0413Z"
              stroke="#D8DFEE"
              stroke-width="1.5"
            ...
            />
            <path
              d="M14.1422 14.1426L19.799 19.7994"
              stroke="#D8DFEE"
              stroke-width="1.5"
              stroke-linecap="round"
              stroke-linejoin="round"
            />
            <path
              d="M14.1421 19.7994L19.7989 14.1426"
              stroke="#D8DFEE"
              stroke-width="1.5"
              stroke-linecap="round"
              stroke-linejoin="round"
        ...
        <div className="icon-modal-header">
          <div className="icon-modal-icon-wrap">
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          <div className="icon-modal-title-group">
            <h4 className="icon-modal-title">{icon.title}</h4>
            <p className="icon-modal-subtitle">{icon.subtitle}</p>
          </div>
        </div>

        <div className="icon-modal-divider" />

        <p className="icon-modal-description">{icon.description}</p>
      </motion.div>
    </motion.div>
  );
};
              ...
              >
                ...
                >
                  ...
                  <motion.div variants={tabBtnVariants}>
                    <GradientButton onClick={() => navigate(tab.link)}>
                      {tab.buttonLabel}
                    </GradientButton>
                  </motion.div>
