...
const ICONS = [
  {
    ...
    subtitle: "Faster Help When Riders Need It Most",
    description:
      "For riders, the greatest danger often starts after the crash. Injured or unconscious riders may be unable to call for help, while family or emergency responders may not know their location for hours. Delayed response can worsen injuries and reduce survival chances. Unlike cars with automatic emergency systems like eCall, most motorcycles lack this protection. The SI Smart System is designed to bridge this gap.",
    paths: [
  ...
  },
  {
    ...
    viewBox: "0 0 36 36",
    title: "SI Connect",
    subtitle: "Real-Time Satellite Network Management",
    description:
      "SI Connect is a powerful web-based dashboard application designed to monitor, manage, and optimize satellite operations in real time. It provides live tracking of connections through GPS, enabling businesses to gain complete visibility over their network's movement, routes, and performance. With an intuitive interface, the platform allows users to make data-driven decisions and ensure smooth operations.",
    paths: [
      {
  ...
  },
  {
    ...
    description:
      "Our AI Integration layer brings machine learning and intelligent automation to every aspect of your operations. From predictive maintenance and anomaly detection to natural language interfaces and automated reporting, the AI layer continuously learns from your data to surface insights and automate repetitive tasks so your team can focus on what matters most.",
    paths: [
      {
  ...
  },
  {
    ...
    description:
      "SI Intelligent is a powerful web-based dashboard application designed to monitor, manage, and optimize AI-powered operations in real time. It provides live analytics and automation that surfaces actionable intelligence, enabling businesses to gain complete visibility over their operational data. With an intuitive interface and centralized control, the platform allows users to make data-driven decisions and streamline workflows.",
    strokePaths: [
