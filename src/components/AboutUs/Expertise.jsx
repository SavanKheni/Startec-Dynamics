    ...
    <div className="Expertise-main">
      ...
      >
        ...
        <p>
          <b>
            {" "}
            By merging cutting-edge research from Canada with real-world testing
            in Cambodia,
          </b>{" "}
          ...
          <motion.div className="expertise-plan-item" variants={fadeInUp}>
            ...
            <div className="expertise-text">
              ...
              <p>
                ...
                weather, rugged terrain, and tough road conditions, it can excel
                anywhere. By providing ease, safety, and security to Cambodians,
                it shows its potential to do the same in other developing
                nations facing similar obstacles, like limited infrastructure
                and restricted access to emergency services.
              </p>
            </div>
          </motion.div>
        </motion.div>
