...
const iconPop = (delay = 0) => ({
  hidden: { opacity: 0, scale: 0.5, rotate: -15, filter: "blur(3px)" },
  visible: {
    opacity: 1,
    scale: 1,
    rotate: 0,
...
const PlanItem = ({ icon, title, text, delay }) => {
  const { ref, inView } = useSection(0.15);
      ...
      <div className="expertise-icon">
        ...
        <div className="expertise-icon-shadow">
          <svg
            ...
            fill="none"
          >
            <g opacity="0.3" filter="url(#eis_filter)">
              <ellipse
                cx="84.5"
                cy="63"
                rx="57"
...
const Expertise = () => {
  ...
  const headInView = useInView(headRef, { once: false, amount: 0.4 });
    ...
    <div className="expertise-section-container">
      <div className="Expertise-main">
        ...
        >
          ...
          {/* Plan items with animated connector line */}
          <div className="expertise-plan">
            {/* Animated vertical line */}
            <motion.span
              ref={lineRef}
              className="expertise-plan-line"
              variants={lineGrow}
              initial="hidden"
            ...
            <PlanItem
              ...
              text="The Startec Intelligent, developed by Startec Dynamics in collaboration with the University of Calgary's Life Sciences Innovation Hub, unites leading tech minds to establish new motorcycle safety standards specifically for developing countries."
              icon={
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="54"
            ...
            <PlanItem
              delay={0.2}
              title="Startec Intelligent Tested by Calypso in Cambodia"
              text="If a Startec vehicle can withstand Cambodia's challenging weather, rugged terrain, and tough road conditions, it can excel anywhere. By providing ease, safety, and security to Cambodians, it shows its potential to do the same in other developing nations facing similar obstacles, like limited infrastructure and restricted access to emergency services."
              icon={
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="45"
