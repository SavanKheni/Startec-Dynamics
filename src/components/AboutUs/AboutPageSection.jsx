      ...
      <motion.div className="about-section-right">
        <div className={`text-wrapper ${expanded ? "expanded" : ""}`}>
          <p>
            ...
            innovation. Founded in 2022 and headquartered in Vancouver, Canada,
            the company focuses on developing advanced smart safety systems for
            motorcycles and light vehicles. At the heart of our innovation is
            Startec Intelligent—a next-generation smart platform that turns
            vehicles into connected, intelligent companions. By integrating
            artificial intelligence, real-time monitoring, and emergency
            response systems, we enhance rider safety, security, and overall
            driving experience.
          </p>
          ...
          <p>
            ...
            diverse environments. Our solutions are designed to perform reliably
            in both developed and emerging markets, ensuring accessibility,
            adaptability, and impact at scale.
          </p>
          ...
          <p>
            ...
            riders worldwide—creating a safer, smarter, and more connected
            future for millions.
          </p>
        </div>
